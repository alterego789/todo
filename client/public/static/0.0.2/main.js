      ...
      if (true) {
        (function() {
          ...
          function updateTransition() {
            var _updateState2 = updateState2(), isPending = _updateState2[0];
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  var calculateItemCompletion = (item) => {
    let total = 0;
    let completed = 0;
  ...
  var UbiWebSocket = class {
    constructor(url) {
      ...
      this.watchForConnection = () => {
        if (this.ws.readyState === this.ws.OPEN) {
          ...
          setTimeout(this.watchForConnection, 5e3);
        }
      };
      this.initWs(url);
    }
    ...
    dispatch(type, payload) {
      if (this.ws.readyState !== this.ws.OPEN) {
        ...
        const found = this.pendingRequests.find((r2) => {
          if (r2[1]?.id) {
            return;
          }
          const rkey = r2[0] + r2[1]?.id;
          return key === rkey;
        });
        if (found) {
  ...
  var savedStateString = localStorage.getItem("state");
  var savedState = savedStateString ? JSON.parse(savedStateString) : {};
  var globalState = {
    ...defaultState,
    ...savedState,
    init: INIT_START
  ...
  var actions = {
    ...
    updateItem: (item) => {
      ...
      const root2 = path.pop();
      ws.dispatch("item.update", root2);
    },
    updateItemSilently: (item) => {
  ...
  var updateFromStorage = () => {
    ...
    const savedStateString2 = localStorage.getItem("state");
    const savedState2 = savedStateString2 ? JSON.parse(savedStateString2) : {};
    if (savedState2) {
      actions.updateFullState(savedState2);
    }
  };
  var useGlobalState = (deps) => {
    const [state, setState] = (0, import_react3.useState)(globalState);
    (0, import_react3.useEffect)(() => {
      setStates.push(setState);
      const updateOff = ws.on("item.update", (item) => {
  ...
  // js/components/breadcrumbs.tsx
  var import_react5 = __toESM(require_react());

  // js/components/icon.tsx
  var import_react4 = __toESM(require_react());
  var Icon = ({ children, onClick }) => {
  ...
  var Breadcrumbs = () => {
    ...
    const tree = buildTree(itemId, gState.items).reverse();
    return /* @__PURE__ */ import_react5.default.createElement("div", {
      ...
      to: "/"
    }, /* @__PURE__ */ import_react5.default.createElement(Icon, null, "home"))), tree.map((it) => /* @__PURE__ */ import_react5.default.createElement("span", {
      className: "breadcrumb-item",
      key: it.id.toString()
    }, /* @__PURE__ */ import_react5.default.createElement(Link, {
      to: "/todo/" + it.id
  ...
  // js/components/edit-item-details.tsx
  var import_react6 = __toESM(require_react());
  var EditDetails = ({ item }) => {
    const { actions: actions2 } = useGlobalState([item]);
    const updateDetails = (0, import_react6.useCallback)((e) => {
      const val = e.target.value;
      actions2.updateItemDetails(item)(val);
    }, []);
  ...
  // js/components/input.tsx
  var import_react7 = __toESM(require_react());

  // js/store/todo-item.ts
  var makeTodoItem = (title, parentId) => {
    return {
      id: newUUID(),
      parentId,
      title,
  ...
  // js/components/input.tsx
  var Input = ({ itemId }) => {
    const { actions: actions2 } = useGlobalState();
    ...
    const handleKeyPress = (0, import_react7.useCallback)((event) => {
      ...
      input.current.value = "";
      const item = makeTodoItem(value, itemId);
      actions2.addItem(item, itemId);
    }, [itemId]);
    ...
    }, /* @__PURE__ */ import_react7.default.createElement("label", null, "Enter todo item and hit enter", /* @__PURE__ */ import_react7.default.createElement("input", {
      ref: input,
      onKeyPress: handleKeyPress,
      onChange: handleChange
    })), /* @__PURE__ */ import_react7.default.createElement("span", {
      className: "input-error " + (error ? "fade-in" : "fade-out")
    }, error));
  };

  // js/components/not-found.tsx
  var import_react8 = __toESM(require_react());
  var NotFound = () => {
    return /* @__PURE__ */ import_react8.default.createElement("h1", {
      className: "error"
    }, /* @__PURE__ */ import_react8.default.createElement(Link, {
      to: "/"
    }, /* @__PURE__ */ import_react8.default.createElement(Icon, null, "home")), " 404 - Not found ", /* @__PURE__ */ import_react8.default.createElement(Icon, null, "error_outline"));
  };

  // js/components/todo-item-view.tsx
  var import_react9 = __toESM(require_react());
  var TodoItemView = ({ item }) => {
    const { actions: actions2 } = useGlobalState([item]);
    ...
    }, item.title), " ", completion[1] ? completion.join("/") : null), /* @__PURE__ */ import_react9.default.createElement("span", null, /* @__PURE__ */ import_react9.default.createElement("span", null, item.completed ? /* @__PURE__ */ import_react9.default.createElement("span", {
      className: "tick absolute"
    }, /* @__PURE__ */ import_react9.default.createElement(Icon, null, "done")) : null, /* @__PURE__ */ import_react9.default.createElement(Icon, {
      onClick: actions2.toggleItemState(item.id)
    }, "crop_square")), /* @__PURE__ */ import_react9.default.createElement(Icon, {
      onClick: actions2.removeItem(item.id)
    }, "delete")));
  };
  ...
  var App = () => {
    const { itemId } = useParams();
    const { gState, actions: actions2 } = useGlobalState([itemId]);
    const item = findItem(itemId, gState.items);
    const children = item?.details.items;
    if (gState.init === INIT_START) {
      if (itemId) {
        actions2.loadDetails(itemId);
      }
    ...
    if (!item?.details.items) {
      return /* @__PURE__ */ React7.createElement("div", {
        className: "main-app"
      }, /* @__PURE__ */ React7.createElement(NotFound, null));
    }
    const completion = calculateItemCompletion(item);
    return /* @__PURE__ */ React7.createElement(React7.Fragment, null, /* @__PURE__ */ React7.createElement(Breadcrumbs, null), /* @__PURE__ */ React7.createElement("div", {
      className: "main-app"
    }, /* @__PURE__ */ React7.createElement("h2", null, item.title, " ", completion[1] ? completion.join("/") : null), /* @__PURE__ */ React7.createElement(Input, {
      itemId
    }), /* @__PURE__ */ React7.createElement("div", {
      className: "item-details"
    }, /* @__PURE__ */ React7.createElement("div", {
      className: "item-list"
    }, children?.length === 0 ? /* @__PURE__ */ React7.createElement("span", {
      className: "no-data-placeholder"
    }, /* @__PURE__ */ React7.createElement(Icon, null, "published_with_changes")) : children?.map((it) => /* @__PURE__ */ React7.createElement("div", {
      key: it.id.toString(),
      className: "item-container"
    }, /* @__PURE__ */ React7.createElement(TodoItemView, {
      item: it
    })))), /* @__PURE__ */ React7.createElement(EditDetails, {
      item
    }))));
  };

  // js/components/home.tsx
  ...
  var Home = () => {
    ...
    return /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(Breadcrumbs, null), /* @__PURE__ */ React8.createElement("div", {
      ...
      className: "item-list"
    }, rootItems?.length === 0 ? /* @__PURE__ */ React8.createElement("span", {
      className: "no-data-placeholder"
  ...
  // js/main.tsx
  var Main = () => /* @__PURE__ */ React9.createElement(BrowserRouter, null, /* @__PURE__ */ React9.createElement(Routes, null, /* @__PURE__ */ React9.createElement(Route, {
    path: "/todo/:itemId",
    element: /* @__PURE__ */ React9.createElement(App, null)
  }), /* @__PURE__ */ React9.createElement(Route, {
    path: "/",
    element: /* @__PURE__ */ React9.createElement(Home, null)
  })));
